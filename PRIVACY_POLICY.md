...
Poly is built on the principle that your meeting data should remain private and under your control. This privacy policy explains how we handle data in our open-source meeting assistant.
...
### What We Collect
Usage analytics is optional and off by default. When you choose to enable it, Poly collects minimal, anonymized usage data:
...
- **GitHub Issues**: [Create an issue](https://github.com/astra-hq/poly/issues)
- **GitHub Discussions**: [Start a discussion](https://github.com/astra-hq/poly/discussions)
...
*This privacy policy applies to Poly v0.0.5 and later versions. For enterprise deployments, additional privacy controls may be available.*

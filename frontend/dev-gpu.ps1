# GPU-accelerated development script for Poly (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for Poly" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting Poly in development mode..." -ForegroundColor Blue
Write-Host ""

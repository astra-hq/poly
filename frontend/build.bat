@echo off
REM Poly Build Script for Windows
...
echo 🚀 Building Poly application...
...
echo.
echo DESCRIPTION:
echo   This script builds the Poly Tauri application for Windows.

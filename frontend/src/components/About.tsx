...
export function About() {
    ...
    const handleContactClick = async () => {
        try {
            await invoke('open_external_url', { url: 'https://github.com/astra-hq/poly' });
        } catch (error) {
    ...
    return (
        <div className="p-4 space-y-4 h-[80vh] overflow-y-auto">
            ...
            <div className="text-center">
                ...
                {/* <h1 className="text-xl font-bold text-gray-900">Poly</h1> */}
            ...
            <div className="space-y-3">
                <h2 className="text-base font-semibold text-gray-800">What makes Poly different</h2>
            ...
            <div className="text-center space-y-2">
                <h3 className="text-medium font-semibold text-gray-800">Open Source & Community-Driven</h3>
                <p className="text-s text-gray-600">
                    Poly is a community fork, built in the open. Contribute, report issues, or just star the repo.
                </p>
                <button
            ...
            <div className="pt-2 border-t border-gray-200 text-center">
                <p className="text-xs text-gray-400">
                    Community fork of the original open-source meeting assistant project
                </p>
            </div>

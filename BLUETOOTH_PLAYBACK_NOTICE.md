...
When **reviewing recordings** in Poly, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **Poly records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing Poly recordings** - Use wired/speakers instead
...
### This is Not a Poly Bug

The issue is in **macOS's Bluetooth audio stack**, not in Poly's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a Poly bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Poly now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: Poly v0.0.5+ on macOS

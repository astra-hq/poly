...
Thank you for your interest in contributing to Poly! This document provides guidelines and instructions for contributing to this project.
...
3. Add the original repository as upstream:
   ```bash
   git remote add upstream https://github.com/astra-hq/poly.git
   ```

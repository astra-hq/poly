# Building Poly from Source

This guide provides detailed instructions for building Poly from source on different operating systems.
...
This guide helps you build Poly on Linux with **automatic GPU acceleration**. The build system detects your hardware and configures the best performance automatically.
...
```
src-tauri/target/release/bundle/appimage/Poly_<version>_amd64.AppImage
```

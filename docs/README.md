...
- **Getting started (from scratch)** → [guides/GETTING_STARTED.md](guides/GETTING_STARTED.md)
- **Building from source** → [guides/BUILDING.md](guides/BUILDING.md)
